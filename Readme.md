...
Our MATLAB toolbox includes all procedures of basis orthogonalizations. Run sample script ***wh_filter.m*** to construct bases orthogonal Weyl-Heisenberg basis using discrete Zak transform.  
```
