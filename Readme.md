...
Our MATLAB toolbox includes all procedures of basis orthogonalizations.  
Run sample script ***wh_filter.m*** to construct bases: Gabor (*non-orthogonal*) and Weyl-Heisenberg (*orthogonal*).  
```
