...
%% Построение матрицы оптимального базиса Вейля-Гейзенберга с использованием спектрального разложения
tic;
W = weylhz(M, L, a, sigma);
disp('Время синтеза базиса с использованием спектрального разложения:')
toc;

%% Построение матрицы оптимального базиса Вейля-Гейзенберга с использованием быстрого алгоритма
tic;
